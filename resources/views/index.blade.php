...
<head>
<meta charset="utf-8">
<title>Braine Digital Agency Business blade.php-5 Template | Homepage 01</title>
<!-- Stylesheets -->
...
<div class="page-wrapper">
	...
	<header class="main-header header-style-one">
			...
			<div class="auto-container">
				<div class="inner-container">
					<div class="d-flex justify-content-between align-items-center flex-wrap">
						...
						<div class="logo-box">
							<div class="logo"><a href="/"><img src="assets/images/logo-removebg.png" alt="" title="" width="80" height="800"></a></div>
						</div>
									...
									<ul class="navigation clearfix">
										...
										<li class="dropdown"><a href="#">Pages</a>
											<ul>
												...
												<li><a href="pricing.blade.php">Price</a></li>
												...
												<li><a href="reset.blade.php">Forgot password</a></li>
												<li class="dropdown"><a href="#">Team</a>
													<ul>
														<li><a href="team.blade.php">Team</a></li>
														<li><a href="team-detail.blade.php">Team detail</a></li>
													</ul>
												</li>
											</ul>
										</li>
										<li class="dropdown"><a href="#">Services</a>
											<ul>
												...
												<li><a href="service-detail.blade.php">Services detail</a></li>
											</ul>
										</li>
										<li class="dropdown"><a href="#">Blog</a>
											<ul>
												<li><a href="blog.blade.php">Blog grid</a></li>
												<li><a href="blog-classic.blade.php">Blog classic</a></li>
												<li><a href="news-detail.blade.php">Blog detail</a></li>
												<li><a href="not-found.blade.php">Not found</a></li>
											</ul>
										</li>
		...
		<div class="mobile-menu">
			...
			<nav class="menu-box">
				<div class="nav-logo"><a href="/"><img src="assets/images/mobile-logo.svg" alt="" title=""></a></div>
			...
			<div class="row clearfix">
				...
				<div class="service-block_one col-lg-4 col-md-6 col-sm-12">
					<div class="service-block_one-inner wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
						...
						<h5 class="service-block_one-heading"><a href="service-detail.blade.php">Digital marketers</a></h5>
						...
						<div class="lower-box d-flex justify-content-between align-items-center flex-wrap">
							...
							<a class="service-block_one-join" href="service-detail.blade.php">Join now <i class="fa-solid fa-plus fa-fw"></i></a>
						</div>
					</div>
				</div>
				...
				<div class="service-block_one col-lg-4 col-md-6 col-sm-12">
					<div class="service-block_one-inner wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
						...
						<h5 class="service-block_one-heading"><a href="service-detail.blade.php">Content marketers</a></h5>
						<div class="service-block_one-text">Lorem ipsum dolor sit ame consectetur adipiscing elit Ut et <span>massa mi. Aliquam</span> in hendrerit urna..</div>
						<div class="lower-box d-flex justify-content-between align-items-center flex-wrap">
				...
				<div class="service-block_one col-lg-4 col-md-6 col-sm-12">
					<div class="service-block_one-inner wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1500ms">
						...
						<h5 class="service-block_one-heading"><a href="service-detail.blade.php">Founders</a></h5>
						<div class="service-block_one-text">Lorem ipsum dolor sit ame consectetur adipiscing elit Ut et <span>massa mi. Aliquam</span> in hendrerit urna..</div>
						<div class="lower-box d-flex justify-content-between align-items-center flex-wrap">
				...
				<div class="service-block_one col-lg-4 col-md-6 col-sm-12">
					<div class="service-block_one-inner wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
						...
						<h5 class="service-block_one-heading"><a href="service-detail.blade.php">Copywriters</a></h5>
						<div class="service-block_one-text">Lorem ipsum dolor sit ame consectetur adipiscing elit Ut et <span>massa mi. Aliquam</span> in hendrerit urna..</div>
						<div class="lower-box d-flex justify-content-between align-items-center flex-wrap">
				...
				<div class="service-block_one col-lg-4 col-md-6 col-sm-12">
					<div class="service-block_one-inner wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
						...
						<h5 class="service-block_one-heading"><a href="service-detail.blade.php">SEO specialists</a></h5>
						<div class="service-block_one-text">Lorem ipsum dolor sit ame consectetur adipiscing elit Ut et <span>massa mi. Aliquam</span> in hendrerit urna..</div>
						<div class="lower-box d-flex justify-content-between align-items-center flex-wrap">
				...
				<div class="service-block_two col-lg-4 col-md-6 col-sm-12">
					<div class="service-block_two-inner wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1500ms">
						...
						<h5 class="service-block_two-heading"><a href="service-detail.blade.php">More service</a></h5>
						<div class="service-block_two-text">Lorem ipsum dolor sit ame consectetur.</div>
						<div class="service-block_two-button">
							<a href="service.blade.php" class="template-btn btn-style-one">
								<span class="btn-wrap">
		...
		<div class="auto-container">
			<div class="inner-container">
				...
				<div class="steps-one_button">
					<a href="/about" class="template-btn btn-style-two">
						<span class="btn-wrap">
							<span class="text-one">Know more</span>
							<span class="text-two">Know more</span>
						</span>
				...
				<div class="faq-one_title-column col-lg-5 col-md-12 col-sm-12">
					<div class="faq-one_title-outer">
						...
						<div class="faq-one_button">
							<a href="/contact" class="template-btn btn-style-one">
								<span class="btn-wrap">
				...
				<div class="swiper-wrapper">
						...
						<div class="news-block_one">
							<div class="news-block_one-inner">
								<div class="news-block_one-image">
									<a href="news-detail.blade.php"><img src="assets/images/resource/news-1.jpg" alt="" /></a>
								</div>
								<div class="news-block_one-content">
									<h5 class="news-block_one-title"><a href="news-detail.blade.php">Transforming industries and shaping the future</a></h5>
									...
									<div class="news-block_one-button">
										<a href="blog.blade.php" class="template-btn btn-style-two">
											<span class="btn-wrap">
					...
					<div class="swiper-slide">
						...
						<div class="news-block_one">
							<div class="news-block_one-inner">
								<div class="news-block_one-image">
									<a href="news-detail.blade.php"><img src="assets/images/resource/news-2.jpg" alt="" /></a>
								</div>
								<div class="news-block_one-content">
									<h5 class="news-block_one-title"><a href="news-detail.blade.php">Exploring the cutting-edge of artificial intelligence</a></h5>
									<div  class="news-block_one-text">Lorem ipsum dolor sit amet consectetur adipiscing vitae mattis tellus. Nullam quis mattis ligula consectetur.</div>
									<div class="news-block_one-button">
										<a href="blog.blade.php" class="template-btn btn-style-two">
											<span class="btn-wrap">
					...
					<div class="swiper-slide">
						...
						<div class="news-block_one">
							<div class="news-block_one-inner">
								<div class="news-block_one-image">
									<a href="news-detail.blade.php"><img src="assets/images/resource/news-3.jpg" alt="" /></a>
								</div>
								<div class="news-block_one-content">
									<h5 class="news-block_one-title"><a href="news-detail.blade.php">Understanding the basics of artificial intelligence</a></h5>
									<div  class="news-block_one-text">Lorem ipsum dolor sit amet consectetur adipiscing vitae mattis tellus. Nullam quis mattis ligula consectetur.</div>
									<div class="news-block_one-button">
										<a href="blog.blade.php" class="template-btn btn-style-two">
											<span class="btn-wrap">
					...
					<div class="cta-one_title-column col-lg-6 col-md-12 col-sm-12">
						<div class="cta-one_title-outer">
							...
							<div class="cta-one_button">
								<a href="/about" class="template-btn btn-style-three">
									<span class="btn-wrap">
										<span class="text-one">Get started free</span>
										<span class="text-two">Get started free</span>
									</span>
		...
		<div class="footer-bottom">
			<div class="auto-container">
				<div class="inner-container d-flex justify-content-between align-items-center flex-wrap">
					<div class="footer-logo"><a href="index.blade.php"><img src="assets/images/logo.svg" alt="" title=""></a></div>
					<div class="footer-copyright">&copy; 2024 <a href="index.blade.php">Braine.</a> All rights reserved.</div>
					<!-- Social Box -->
