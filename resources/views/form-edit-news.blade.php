    ...
    <div class="page-wrapper">
        ...
        <section class="register-one">
            <div class="team-detail_button">
                <a href="{{ route('news.dashdetail', ['id' => $berita->id_berita])}}" class="template-btn btn-style-one">
                    <span class="btn-wrap">
                    ...
                    <div class="register-form">
                        <form method="post" action="{{ route('berita.update', $berita->id_berita) }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" id="foto1" name="foto1" value="{{ $berita->foto1 }}" accept=".jpg,.jpeg,.png" onchange="validateFoto1(event)">
                                <br>
                            ...
                            <div class="form-group">
                                <label>Foto 2</label>
                                <input type="file" id="foto2" name="foto2" value="{{ $berita->foto2 }}" accept=".jpg,.jpeg,.png" onchange="validateFoto2(event)">
                                <br>
                            ...
                            <div class="form-group">
                                <label>Foto 3</label>
                                <input type="file" id="foto3" name="foto3" value="{{ $berita->foto2 }}" accept=".jpg,.jpeg,.png" onchange="validateFoto3(event)">
                                <br>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="judul" name="judul" value="{{ $berita->judul }}" placeholder="" required="">
                            </div>

                            <div class="form-group">
                                <label>Isi Berita</label>
                                <input type="text" id="berita" name="berita" value="{{ $berita->berita }}" placeholder="" required="">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="dropdown" id="penulis" name="penulis" value="{{ $berita->penulis }}">
                            ...
                            <div class="form-group">
                                <label>Tanggal</label>
                                <input type="date" id="tanggal" name="tanggal" value="{{ $berita->tanggal }}" placeholder="" required="">
                            </div>
